...
public class VerticalFlowLayout implements LayoutManager, java.io.Serializable {
     ...
     * @see        gui.VerticalFlowLayout#setAlignment
     * @since      JDK1.1
     */
     ...
     *             and between the components and the borders
     *             of the <code>Container</code>
     * @see        gui.VerticalFlowLayout#setHgap
     * @since      JDK1.1
     */
    public int getHgap() {
	return hgap;
     ...
     *             and between the components and the borders
     *             of the <code>Container</code>
     * @see        gui.VerticalFlowLayout#getHgap
     * @since      JDK1.1
     */
     ...
     *             and between the components and the borders
     *             of the <code>Container</code>
     * @see        gui.VerticalFlowLayout#setVgap
     * @since      JDK1.1
     */
    public int getVgap() {
	return vgap;
     ...
     *             and between the components and the borders
     *             of the <code>Container</code>
     * @see        gui.VerticalFlowLayout#getVgap
     * @since      JDK1.1
     */
